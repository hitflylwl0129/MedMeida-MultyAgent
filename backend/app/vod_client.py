...
def create_aigc_video_task(
    *,
    ...
    # 打印实际提交的 Prompt 全文，便于回溯每条视频用的是什么提示词
    log.info("CreateAigcVideoTask Prompt=%s", prompt)
...
def create_motion_control_task(
    *,
    ...
    # 打印实际提交的 Prompt 全文（motion_control 场景 Prompt 为辅助引导，可能为空）
    log.info("CreateAigcVideoTask(motion_control) Prompt=%s", prompt or "(空)")
